...
const uf2Source = existsSync('firmware/release/flowdesk_usb_bridge.uf2')
  ? 'firmware/release/flowdesk_usb_bridge.uf2'
  : (existsSync('firmware/build/flowdesk_usb_bridge.uf2') ? 'firmware/build/flowdesk_usb_bridge.uf2' : null);
if (uf2Source) {
  await copyFile(uf2Source, 'desktop-build/firmware/flowdesk_usb.uf2');
}
